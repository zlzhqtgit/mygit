			...
			<div class="mainleft">
				...
				<div class="leftinfos">
					...
					<div class="inforight">
						...
						<ul class="tooli">
							<li><span><img src="${pageContext.request.contextPath}/images/d01.png" /></span>
								<p>
									<a href="#">信息资料</a>
								</p>
							</li>
							<li><span><img src="${pageContext.request.contextPath}/images/d02.png" /></span>
								<p>
									<a href="#">编辑</a>
								</p>
							</li>
							<li><span><img src="${pageContext.request.contextPath}/images/d03.png" /></span>
								<p>
									<a href="#">记事本</a>
								</p>
							</li>
							<li><span><img src="${pageContext.request.contextPath}/images/d04.png" /></span>
								<p>
									<a href="#">任务日历</a>
								</p>
							</li>
							<li><span><img src="${pageContext.request.contextPath}/images/d05.png" /></span>
								<p>
									<a href="#">图片管理</a>
								</p>
							</li>
							<li><span><img src="${pageContext.request.contextPath}/images/d06.png" /></span>
								<p>
									<a href="#">交易</a>
								</p>
							</li>
							<li><span><img src="${pageContext.request.contextPath}/images/d07.png" /></span>
								<p>
									<a href="#">档案袋</a>
								</p>
							</li>
