					...
					<div class="page_step step2 margin_top hide">
						...
						<form class="" action="" method="post">
							<fieldset id="">
								...
								<div class="padding-side2 margin_bot margin_top1">
									...
									<div class="">
										...
										<input id="password" type="text" title="请填写6-16位数字、字母或符号作为密码" placeholder="请填写6-16位数字、字母或符号作为密码"/>
							...
							<div class="text-center margin_top1 margin_bot">
								<input onclick="register(this)" class="btn btn-default disabled" type="button" value="注册"/>
							</div>
						</form>
