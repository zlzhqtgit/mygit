		...
		<main class="container">
			<section class="row">
				<div class="test_instruction">
					<h1 class="text-primary">霍兰德职业兴趣测评</h1>
					<div class="thumbnail">
						<div class="caption answer_temp">
							...
							<p class="text-right"><a href="${pageContext.request.contextPath}/cp/xgk_answer.do?cpid=1" class="btn btn-primary" role="button">开始答题</a></p>
						</div>
					</div>
				</div>
			</section>
