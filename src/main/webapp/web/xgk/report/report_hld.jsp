...
<script src="${pageContext.request.contextPath}/js/common.js"></script>
		<main class="container">
			<div class="row">
				<p class="text-right"><a href="javascript:void(0)" class="downloadReport btn btn-primary">打印报告</a></p>
				<section class="p_relative" id="report_cont">
				<section class="" id="report_cont">
