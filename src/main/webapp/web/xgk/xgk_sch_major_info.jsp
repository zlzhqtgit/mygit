			...
			<div class="panel-heading"
				...
				<div class="row">
					...
					<div class="col-md-4 col-lg-4 col-sm-4 collection margin_top">
						<div class="">
							<a href="javascript:void(0)" onclick="test()"><span class=""><img
									src="${pageContext.request.contextPath}/img/xgk/ic3.png" /></span>测评选专业</a>
						</div>
						<script type="text/javascript">
							function test() {
								layer
						...
						<div class="like">
							<c:if test="${school_like != null}">
								<a id="${school_like.eId}" href="javascript:;"
									onclick="like(this)">&emsp;&emsp;喜欢 <img
									src="${pageContext.request.contextPath}/img/xgk/like.png" />
								</a>
							</c:if>
							<c:if test="${school_like == null}">
								<a id="" href="javascript:;" onclick="like(this)">&emsp;&emsp;喜欢
									<img
									src="${pageContext.request.contextPath}/img/xgk/unlike.png" />
								</a>
							</c:if>
						</div>
					</div>
						...
						<div class="major_info">
							<div class="items margin_top">
								...
								<div class="circle_list">
									<div class="">
										<img src="${pageContext.request.contextPath}/img/xgk/ic1.png"
											style="" /> <span class="text-center padding-side">
											<div class="">${specialty.specialtyEducation }</div>
											<div class="">学历层次</div>
										</span>
									</div>
									<div class="">
										<img src="${pageContext.request.contextPath}/img/xgk/ic2.png"
											style="" /> <span class="text-center padding-side">
									...
									<div class="">
										<img src="${pageContext.request.contextPath}/img/xgk/ic4.png"
											style="" /> <span class="text-center padding-side">
									...
									<div class="">
										<img src="${pageContext.request.contextPath}/img/xgk/ic5.png"
											style="" /> <span class="text-center padding-side">
							...
							<div class="items margin_top">
								...
								<ul class="padding-side2" style="list-style: disc;">
									<li>
										...
										<div class="">${specialty.specialtySummary}</div>
									</li>
									<li>
										<h4 class="fontwei">培养目标</h4>
										<div class="">${specialty.specialtyObjective}</div>
									</li>
									<li>
										<h4 class="fontwei">培养要求</h4>
										<div class="">${specialty.trainRequirement}</div>
									</li>
									<li>
										<h4 class="fontwei">学科要求</h4>
										<div class="">${specialty.subjectRequirement}</div>
									</li>
									<li>
										<h4 class="fontwei">知识能力</h4>
										<div class="">${specialty.knowledgeAbility }</div>
									</li>
								</ul>
							</div>
							<div class="items margin_top">
					...
					<div class="tab_b2">
						<div class="major_info">
									...
									<div class="">
										<div class="margin_top">
											考生生源地： <select name="" id="er_year">
												...
												<%--												</c:if>--%>
											</select> <select name="" id="er_province">
												<option value="">暂无</option>
										...
										<div class="sch_province flex_jcstart margin_top1">
											<span id="sch_province"> 院校省份： </span>
											<ul id="sch_ur">
							...
							<div class="panel panel-default">
								...
								<!--  分页      -->
								<div class="bg-white p-10 m-t-10 t-a-c"
									style="box-shadow: 0px 0px 0px #bdb8b8;">
											...
											success : function(obj) {
												if (obj.state == 1) {
													...
													for (var i = 0; i < list.length; i++) {
														...
														var admissionLotList = JSON
																.parse(list[i].admissionLot);
														...
														var attrImg = "";//院校属性图片
														var universitiesAttributes = JSON
																.parse(list[i].universitiesAttributes);
														if (universitiesAttributes != null) {
															for (var f = 0; f < universitiesAttributes.length; f++) {
																if (universitiesAttributes[f] == "985") {
																	attrImg += '<img src="${pageContext.request.contextPath}/img/xgk/attr/985.png" width="7%"/>'
																}
																if (universitiesAttributes[f] == "211") {
																	attrImg += '<img src="${pageContext.request.contextPath}/img/xgk/attr/211.png" width="7%"/>'
																}
																if (universitiesAttributes[f] == "双一流") {
																	attrImg += '<img src="${pageContext.request.contextPath}/img/xgk/attr/syl.png" width="7%"/>'
																}
																if (universitiesAttributes[f] == "行业领军") {
																	attrImg += '<img src="${pageContext.request.contextPath}/img/xgk/attr/hylj.png" width="7%"/>'
																}
																if (universitiesAttributes[f] == "研究生院") {
																	attrImg += '<img src="${pageContext.request.contextPath}/img/xgk/attr/yjsy.png" width="7%"/>'
																}
															}
														}
														var master = "";//硕士点数
							...
							<div class="items margin_top">
								...
								<div class="collection row" style="padding: 0 1em;">
									<div class="col-md-4 border_major">
										<ul
											style="padding-left: 1em; list-style: disc; height: 384px; margin: 0;">
											<li>
												<div class="">
													<p class="fontwei occupation_tit">行政/后勤/文秘</p>
													<p id="percent" class="">12.6%</p>
													<p class="text-center">
														<a class="next_one btn btn-default"
															onclick="pie_next_one()" href="javascript:void(0)">下一个</a>
													</p>
												</div>
											</li>
											<li>
									...
									<div class="col-md-8 col-lg-8 col-sm-8 border_major">
										<div id="major"
											style="width: 800px; height: 384px; margin: 0 auto;"></div>
										<script type="text/javascript">
											...
											var career = JSON
													.parse('${employment_career_direction}');
											var data = new Array();
											var count = 0;
											var map = new Map();
											...
											function pie_next_one() {
												...
												$("#vocation")
														.html(
																map
																		.get(datas[index].name));//更新职业介绍信息
												$("#percent").text(
														datas[index].value
																+ '%');//职业率
												$('.occupation_tit').text(
														datas[index].name);//更新职业名字
												myChart.dispatchAction({
													type : 'pieSelect',
													dataIndex : index
												});
								...
								<div class="items margin_top col-md-6 col-lg-6 col-sm-6">
									...
									<ul class="border_major">
										<c:if test="${not empty employment_industry_distribution }">
											<c:forEach items="${employment_industry_distribution }"
												var="item">
												<li>
								...
								<div class="items margin_top col-md-6 col-lg-6 col-sm-6">
									...
									<ul class="border_major">
										<c:if test="${not empty employment_area_distribution }">
											<c:forEach items="${employment_area_distribution }"
												var="item">
												<li>
													<div class="" style="width: 88%;">
														<p class="">${item[0]}</p>
						...
						function() {
							...
							$('.tab_head li').click(
									function() {
										...
										$(this).parents('.tab_list').find(
												'.tab_body').children()
												.removeClass('cur');
										$(this).parents('.tab_list').find(
												'.tab_body').children().eq(
												index).addClass('cur');
									})
						})
				$(function() {
...
<script type="text/javascript">
	...
	for (var i = 0; i < province.length; i++) {
		if (province[i].name.search('${province}') != -1) {
			options += '<option value="'+province[i].name+'" selected="selected">'
					+ province[i].name + '</option>';
		} else {
			options += '<option value="'+province[i].name+'">'
					+ province[i].name + '</option>';
		}
	}
	$("#er_province").html(options);
</script>
</html>