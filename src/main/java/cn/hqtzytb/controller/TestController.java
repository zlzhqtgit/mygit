...
public class TestController {	
	...
	@RequestMapping("/xgk_chat.do")	
	public String xgk_chat(ModelMap map,HttpSession session,HttpServletRequest request,HttpServletResponse response) throws MyRuntimeException{	
