...
public class ZFBpayConfig
{
	...
	{
		return "ZFBpay [app_id=" + app_id + ", merchant_private_key=" + merchant_private_key + ", alipay_public_key="
				+ alipay_public_key + ", notify_url=" + notify_url + ", return_url=" + return_url + ", sign_type="
				+ sign_type + ", charset=" + charset + ", gatewayUrl=" + gatewayUrl + ", log_path=" + log_path + "]";
	}
